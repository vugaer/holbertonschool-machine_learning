...
def autoencoder(input_dims, hidden_layers, latent_dims):
    ...
    Args:
        input_dims: integer, the dimensions of the model input
        hidden_layers: list containing the number of nodes for each
                       hidden layer in the encoder, respectively
        latent_dims: integer, the dimensions of the latent space
                     representation
    ...
    hidden_ly_decoded = keras.layers.Dense(
